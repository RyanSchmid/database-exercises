...
VALUES('Michael Jackson', 'Thriller', 1982, 47.3, 'Pop, rock, R&B'),
      ...
      ('Meat Loaf','Bat Out of Hell',1980,21.5,'Hard rock, Progressive rock'),
      ('Whitney Houston','The Bodyguard',1992,28.4,'Soft rock'),
      ('Eagles','Hotel California',1976,31.5,'Soft rock'),
      ('Bee Gees','Saturday Night Fever',1977,21.6,'Disco'),
      ('Fleetwood Mac','Rumours',1977,27.9,'Soft rock'),
      ('Various artists','Grease: The Original Soundtrack from the Motion Picture',1978,14.4,'Soundtrack/50s rock and roll revival'),
      ...
      ('The Beatles','Sgt. Peppers Lonely Hearts Club',1967,18.2,'Rock'),
